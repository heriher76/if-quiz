...
class React_Native extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      quiz2Givenbefore: localStorage.getItem("react native quiz 2") === "done" ? true : false,
      currentQuiz1: this.props.reactNativeQuiz1,
      currentQuiz2: this.props.reactNativeQuiz2,
    }
  }
  render() {
    const { selectedQuiz, startQuiz, quiz1Givenbefore, currentQuiz1, quiz2Givenbefore, currentQuiz2 } = this.state;
    return (
      <div>
