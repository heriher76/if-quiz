...
class Apna_React extends Component {
  ...
  return (
      <div>
        ...
        <h1 style={{display:'inline'}} onClick={()=> this.setState({selectedQuiz:'',startQuiz:null})}>Simple Future Tense Quizzes</h1>
        ...
        {selectedQuiz!=='Quiz 2' && !currentQuiz2 &&<h2 onClick={()=> this.setState({selectedQuiz:'Quiz 1'})}>Quiz 1</h2>}
          ...
          <div>
            <h2>Simple Future Tense Quiz 1</h2>
        ...
        {selectedQuiz==='Quiz 2' && startQuiz===null && !quiz2Givenbefore &&
          <div>
            <h2>Simple Future Tense Quiz 2</h2>
            <h4>Passing Score : 50</h4>
