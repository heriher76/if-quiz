  ...
  render() {
    ...
    return (
      <div>
        ...
        <h1 style={{ display: 'inline' }} onClick={() => this.setState({ selectedQuiz: '', startQuiz: null })}>Simple Present Tense Quizzes</h1>
        ...
        <div id='categories'>
          ...
          {selectedQuiz === 'Quiz 1' && startQuiz === null && !quiz1Givenbefore &&
            <div>
              <h2>Simple Present Tense Quiz 1</h2>
        ...
        <div id='categories'>
          ...
          {selectedQuiz === 'Quiz 2' && startQuiz === null && !quiz2Givenbefore &&
            <div>
              <h2>Simple Present Tense Quiz 2</h2>
              <h4>Passing Score : 50</h4>
